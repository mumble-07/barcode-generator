...
df = pd.read_excel("random_num.xlsx")
numbers = df['Random Number EAN'].astype(str)  # Replace 'column_name' with the actual column name containing numbers

# Create a folder with timestamp format "day-month-year-time"
timestamp_folder = datetime.now().strftime("%d-%m-%Y-%H%M%S")
os.makedirs(timestamp_folder, exist_ok=True)

# Generate and save barcodes with timestamp
